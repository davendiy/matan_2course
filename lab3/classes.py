...
class Function:
    ...
    >>> f = Function(['x1', 'x2'], func=lambda a, b: a ** 2 + b ** 2)
    ...
    def __init__(self, variables: list, func):
        ...
        >>> f = Function(['x1', 'x2'], func)   # об'єкт класу 'функція', з змінними х1 і х2

        :param variables: список рядків
        :param func: функціональний тип
        """
        assert isinstance(variables, list), "неправильний тип змінних"
        for el in variables:
    ...
    def __str__(self):
        return 'Function({})'.format(self._func.__doc__)
